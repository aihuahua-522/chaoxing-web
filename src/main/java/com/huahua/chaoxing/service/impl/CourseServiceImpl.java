...
public class CourseServiceImpl implements CourseService {
  ...
  public ResultBean<String> addCourse(String courseBeans, String tel, String pass) {
    Type type = new TypeToken<ArrayList<CourseBean>>() {}.getType();
  ...
  @Override
  public int deleteOne(BigInteger tel, String courseId, String classId) {
    try (SqlSession sqlSession = MybatisUtil.getSqlSession()) {
      CourseMapper mapper = sqlSession.getMapper(CourseMapper.class);
      final int i = mapper.deleteOneCoure(tel, courseId, classId);
      sqlSession.commit();
      return i;
    }
  }
